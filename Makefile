...
HTTPS_GIT := github.com/mygithub/mychain22.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=mychain22 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c mychain22 --local -f chains.yaml
endif
